...
App::build(
	[
		...
		'Model/Datasource'          => [APP.'Custom'.DS.'Model'.DS.'Datasource'.DS],
		'Model/Datasource/Database' => [APP.'Custom'.DS.'Model'.DS.'Datasource'.DS.'Database'.DS],
		'Model/Datasource/Session'  => [APP.'Custom'.DS.'Model'.DS.'Datasource'.DS.'Session'.DS],
		'Controller'                => [APP.'Custom'.DS.'Controller'.DS],
		'Controller/Component'      => [APP.'Custom'.DS.'Controller'.DS.'Component'.DS],
		'Controller/Component/Auth' => [APP.'Custom'.DS.'Controller'.DS.'Component'.DS.'Auth'.DS],
		'Controller/Component/Acl'  => [APP.'Custom'.DS.'Controller'.DS.'Component'.DS.'Acl'.DS],
		'View'                      => [APP.'Custom'.DS.'View'.DS],
		'View/Helper'               => [APP.'Custom'.DS.'View'.DS.'Helper'.DS],
		'Console'                   => [APP.'Custom'.DS.'Console'.DS],
		'Console/Command'           => [APP.'Custom'.DS.'Console'.DS.'Command'.DS],
